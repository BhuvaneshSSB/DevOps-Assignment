# Path: infrastructure/terraform/aws/vpc.tf
...
resource "aws_eip" "nat_1" {
  ...
  tags = {
    Name = "${var.app_name}-${var.environment}-eip-1"
  }
...
resource "aws_eip" "nat_2" {
  ...
  tags = {
    Name = "${var.app_name}-${var.environment}-eip-2"
  }
...
resource "aws_nat_gateway" "nat_1" {
  ...
  tags = {
    Name = "${var.app_name}-${var.environment}-nat-1"
  }
...
resource "aws_nat_gateway" "nat_2" {
  ...
  tags = {
    Name = "${var.app_name}-${var.environment}-nat-2"
  }
